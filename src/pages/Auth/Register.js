                    ...
                    <Row className="justify-content-center">
                        <Col md={8} lg={6} xl={5}>
                            <div className="text-center mb-4">
                                ...
                                <h4>{t('Sign up')}</h4>
                                <p className="text-muted mb-4">{t('Get your redSocial account now')}.</p>
                                    ...
                                    <div className="p-3">
                                        ...
                                        <Form onSubmit={formik.handleSubmit}>
                                            ...
                                            <div className="mt-4 text-center">
                                                <p className="text-muted mb-0">{t('By registering you agree to the redSocial')} <Link to="#" className="text-primary">{t('Terms of Use')}</Link></p>
                                            </div>
                            ...
                            <div className="mt-5 text-center">
                                ...
                                <p>© {new Date().getFullYear()} {t('redSocial')}. {t('Crafted with')} <i className="mdi mdi-heart text-danger"></i> {t('by Themesbrand')}</p>
                            </div>
                        </Col>
                    </Row>
                </Container>
